  ...
  return (
    <div className="flex items-center gap-2">
      <button
        ...
        className="relative inline-flex h-8 w-16 items-center rounded-full bg-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-brand-brown focus:ring-offset-2"
        role="switch"
